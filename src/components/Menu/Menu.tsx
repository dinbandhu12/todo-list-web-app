...
const classLinkActive =
  "text-rose-600 bg-sky-100 border-r-4 border-rose-500 dark:bg-slate-700/[.2] dark:text-slate-200 dark:border-slate-200";
  ...
  return (
    ...
    >
      <header className="h-full flex flex-col">
        <h1 className="font-bold uppercase text-center mt-8 text-xl tracking-wide hidden xl:block">
          To-do list
        </h1>
